document.addEventListener("DOMContentLoaded", function () {
    ...
    copyButtons.forEach(function (copyButton) {
        copyButton.addEventListener("click", function () {
            const urlLink = copyButton.nextElementSibling;

            if (urlLink && urlLink.tagName === "A") {
                const linkText = urlLink.textContent;
                ...
                // Reset the SVG path after a delay (e.g., 2 seconds)
                setTimeout(function () {
                    if (svg) {
